...
export class MainLayout {
  ...
  navItems: NavItem[] = [
    { label: 'Inicio', titulo: 'INICIO', route: '/', icon: 'inicio' },
    ...
    { label: 'Mapa', titulo: 'MAPA DE CALOR', route: '/mapa', icon: 'mapa' },
    { label: 'Materia Prima', titulo: 'MATERIA PRIMA', route: '/materia-prima', icon: 'materia-prima' },
